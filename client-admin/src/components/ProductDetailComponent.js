        ...
        <form>
          <table>
            <tbody>
              ...
              <tr>
                <td>Name</td>
                <td><input type="text" value={this.state.txtName} onChange={(e) => {this.setState({txtID: e.target.value})}}/></td>
              </tr>

              <tr>
                <td>Price</td>
                <td><input type="text" value={this.state.txtPrice} onChange={(e) => {this.setState({txtID: e.target.value})}}/></td>
              </tr>
              
              <tr>
                <td>Image</td>
                <td><input type="file" name="fileImage" accept="image/jpg, image/png, image/gif" onChange={(e) => this.previewImage(e)}/></td>
              </tr>
  ...
  componentDidUpdate(prevProps) {
    if (this.props.item !== prevProps.item) {
      this.setState({
        ...
        txtPrice: this.props.item.category._id,
